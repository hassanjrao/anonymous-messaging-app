        ...
        <div class="main-content">
            ...
            <table id="table" class=" table-bordered dt-responsive nowrap" style="width:100%">
                ...
                <tbody>
                    ...
                    $query = $conn->prepare("SELECT * FROM users where role='moderator' order by id desc");
                    $query->execute();
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="delete_moderator.php?id=<?php echo $result["id"]
